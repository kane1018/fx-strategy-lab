"""Run one finite actual Pushover rehearsal; never contacts a broker."""
...
def main() -> int:
    try:
        ...
        operation_permit = ledger.begin(V4PreparationOperation.PUSHOVER)
        ...
        print(f"V4_PUSHOVER_BLOCKED: {error}")
        return 2
