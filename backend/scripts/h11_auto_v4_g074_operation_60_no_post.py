"""One-use G074 operation 60 with separate installer/readiness windows."""
...
from app.services.h11_v4_g074_runtime import (
    G074_OPERATION_60_RESULT_FILE,
    G074_OPERATION_60_STARTED_FILE,
    G074Error,
    engage_g074_halt,
...
def run_g074_operation_60_candidate(
    *,
    state_root: Path,
    ...
    started = state_root / G074_OPERATION_60_STARTED_FILE
    ...
    result_path = state_root / G074_OPERATION_60_RESULT_FILE
    if result_path.exists() or result_path.is_symlink():
        raise G074Error("G074_OPERATION_60_RESULT_EXISTS_NO_RETRY")
    result_path.write_text(json.dumps(result, sort_keys=True), encoding="utf-8")
    if outcome == "UNKNOWN":
        engage_g074_halt(state_root=state_root, reason="G074_OPERATION_60_UNKNOWN")
    return outcome
...
def _exclusive_start(path: Path, generation_digest: str, reviewed_files_digest: str) -> None:
    ...
    try:
        ...
        raise G074Error("G074_OPERATION_60_ALREADY_STARTED_NO_RETRY") from error
...
def main() -> int:
    ...
    outcome = run_g074_operation_60_candidate(
    ...
    print(f"G074_OPERATION_60_{outcome}_NO_POST")
