...
def test_g069_candidate_manifest_is_readable_by_canonical_loader(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        ...
        Path("docs/templates/h11_v4_g069_frozen_generation.json"),
    )
    ...
    assert generation.generation_label == "H11_AUTO_30M_20260802_G069"
