...
- 現在のフェーズ: **Step 6G-PC-OX-R-SEALED-REQUEST-BODY-RESULT-MAPPER-C sealed request/body/result mapper foundation / no actual HTTP POST**。
  ...
  次の推奨Stepは **Step 6G-PC-OX-R-SEALED-CREDENTIAL-SIGNING-PROVIDER-C**。次Stepでもactual POST、
