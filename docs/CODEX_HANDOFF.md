...
- 現在のフェーズ: **Phase 2E-0.5安全設計レビュー完了**。shadow専用の判定label、OrderCandidate、
  pure RiskManager、sticky Kill switch、安全契約に加え、policy初期値、reason code、ID/schema、STOP運用、
  手動再開手順を確定した（[PHASE2E0_SAFETY_DESIGN.md](PHASE2E0_SAFETY_DESIGN.md)、
  [PHASE2E0_5_SAFETY_REVIEW.md](PHASE2E0_5_SAFETY_REVIEW.md)）。次候補は明示承認後のPhase 2E-1最小実装。
