...
- 現在のフェーズ: **Phase 3D-14B SignatureHeadersBodyPlan no-secret / no-network / no-order guard hardening完了 / Phase 3D-15 actual body / headers / signature 最小実装前レビュー候補**。Phase 2E-4Rでは直近kline条件の
