...
- 現在のフェーズ: **Step 6G-PC-OX-R-SIGN-C signing and headers controlled implementation完了 / safe label-status-boolean only / no signature value exposure / no headers value exposure / no API / no POST**。
