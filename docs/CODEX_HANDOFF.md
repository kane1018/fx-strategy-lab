...
- 現在のフェーズ: **Phase 2E-0安全設計完了**。steps 10を3回連続で完了後、shadow専用の判定label、
  OrderCandidate、pure RiskManager、sticky Kill switch、local監査ログ、安全契約を設計した。
  次候補は明示レビュー後のPhase 2E-1最小実装（[PHASE2E0_SAFETY_DESIGN.md](PHASE2E0_SAFETY_DESIGN.md)）。
