...
- 現在のフェーズ: **Step 6G-PC-OX-R-RESULT-C sanitized POST result / reconciliation contract implementation完了 / contract implementation only / no API call / no POST / no live_order_once**。
