...
Corrective core 45、preparation 49、expanded isolation 101、H-11 auto 341 testsとfull ruffは成功。
working tree dirty、HEADがorigin/mainより1 commit先行し、manifest/runtimeの
残VETOもあるため、実Keychain、外部通知、Private GETは未実行。broker POST／permit／canaryは引き続き0。
